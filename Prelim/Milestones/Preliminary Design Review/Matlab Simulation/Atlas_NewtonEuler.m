...
d = Jac_F' * [J_FFJ, skew(G_FFG)*T_ITF'; -T_ITF*skew(G_FFG), m_C*eye(3)] * dot_Jac_C*dot_gamma + Jac_C'*[cross(w_CCwI, J_FFJ*w_CCwI); T_ITF*cross(w_CCwI, cross(w_CCwI, G_FFG))] +...
    ...
    Jac_B1' * [J_B1_B1_J, skew(G_B1_B1_G)*T_ITB1'; -T_ITB1*skew(G_B1_B1_G), m_B1*eye(3)] * dot_Jac_B1*dot_gamma + Jac_B1'*[cross(w_B1_B1_w_I, J_B1_B1_J*w_B1_B1_w_I); T_ITB1*cross(w_B1_B1_w_I, cross(w_B1_B1_w_I, G_B1_B1_G))] +...
    Jac_B2' * [J_B2_B2_J, skew(G_B2_B2_G)*T_ITB2'; -T_ITB2*skew(G_B2_B2_G), m_B2*eye(3)] * dot_Jac_B2*dot_gamma + Jac_B2'*[cross(w_B2_B2_w_I, J_B2_B2_J*w_B2_B2_w_I); T_ITB2*cross(w_B2_B2_w_I, cross(w_B2_B2_w_I, G_B2_B2_G))] +...
    Jac_B3' * [J_B3_B3_J, skew(G_B3_B3_G)*T_ITB3'; -T_ITB3*skew(G_B3_B3_G), m_B3*eye(3)] * dot_Jac_B3*dot_gamma + Jac_B3'*[cross(w_B3_B3_w_I, J_B3_B3_J*w_B3_B3_w_I); T_ITB3*cross(w_B3_B3_w_I, cross(w_B3_B3_w_I, G_B3_B3_G))] +...
    Jac_C1' * [J_C1_C1_J, skew(G_C1_C1_G)*T_ITC1'; -T_ITC1*skew(G_C1_C1_G), m_C1*eye(3)] * dot_Jac_C1*dot_gamma + Jac_C1'*[cross(w_C1_C1_w_I, J_C1_C1_J*w_C1_C1_w_I); T_ITC1*cross(w_C1_C1_w_I, cross(w_C1_C1_w_I, G_C1_C1_G))] +...
    Jac_C2' * [J_C2_C2_J, skew(G_C2_C2_G)*T_ITC2'; -T_ITC2*skew(G_C2_C2_G), m_C2*eye(3)] * dot_Jac_C2*dot_gamma + Jac_C2'*[cross(w_C2_C2_w_I, J_C2_C2_J*w_C2_C2_w_I); T_ITC2*cross(w_C2_C2_w_I, cross(w_C2_C2_w_I, G_C2_C2_G))] +...
    Jac_C3' * [J_C3_C3_J, skew(G_C3_C3_G)*T_ITC3'; -T_ITC3*skew(G_C3_C3_G), m_C3*eye(3)] * dot_Jac_C3*dot_gamma + Jac_C3'*[cross(w_C3_C3_w_I, J_C3_C3_J*w_C3_C3_w_I); T_ITC3*cross(w_C3_C3_w_I, cross(w_C3_C3_w_I, G_C3_C3_G))] +...
    Jac_D1' * [J_D1_D1_J, skew(G_D1_D1_G)*T_ITD1'; -T_ITD1*skew(G_D1_D1_G), m_D1*eye(3)] * dot_Jac_D1*dot_gamma + Jac_D1'*[cross(w_D1_D1_w_I, J_D1_D1_J*w_D1_D1_w_I); T_ITD1*cross(w_D1_D1_w_I, cross(w_D1_D1_w_I, G_D1_D1_G))] +...
    Jac_D2' * [J_D2_D2_J, skew(G_D2_D2_G)*T_ITD2'; -T_ITD2*skew(G_D2_D2_G), m_D2*eye(3)] * dot_Jac_D2*dot_gamma + Jac_D2'*[cross(w_D2_D2_w_I, J_D2_D2_J*w_D2_D2_w_I); T_ITD2*cross(w_D2_D2_w_I, cross(w_D2_D2_w_I, G_D2_D2_G))] +...
    Jac_D3' * [J_D3_D3_J, skew(G_D3_D3_G)*T_ITD3'; -T_ITD3*skew(G_D3_D3_G), m_D3*eye(3)] * dot_Jac_D3*dot_gamma + Jac_D3'*[cross(w_D3_D3_w_I, J_D3_D3_J*w_D3_D3_w_I); T_ITD3*cross(w_D3_D3_w_I, cross(w_D3_D3_w_I, G_D3_D3_G))];
...
%% Friction
B = 0.7*eye(size(b, 1)/2);
C = 1.2*eye(size(b, 1)/2);



%% calculate derivative of state for output
ddot_gamma = H \ (F - d + G - B*dot_gamma - C*sign(dot_gamma));
